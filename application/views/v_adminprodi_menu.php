    ...
    <section class="sidebar">
      <ul class="sidebar-menu">
        <li class="<?php echo $profile;?>">
          <a href="<?php echo base_url(); ?>adminprodi/profile">
            <span>Profile</span>
          </a>
        </li>
        <li class="<?php echo $dosen;?>">
          <a href="<?php echo base_url(); ?>adminprodi/dosen">
            <span>Data Dosen</span>
          </a>
        </li>
        <li class="<?php echo $kelasmahasiswa;?>">
          <a href="<?php echo base_url(); ?>adminprodi/kelasmahasiswa">
            <span>Data Kelas Mahasiswa</span>
          </a>
        </li>
        <li class="<?php echo $matakuliah;?>">
          <a href="<?php echo base_url(); ?>adminprodi/matakuliah">
            <span>Data Mata Kuliah</span>
          </a>
        </li>
        <li class="<?php echo $soal;?>">
          <a href="<?php echo base_url(); ?>adminprodi/soal">
            <span>Data Soal</span>
          </a>
        </li>
		<li class="">
