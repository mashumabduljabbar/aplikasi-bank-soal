		...
		<div class="col-xs-12">
			<div class="box">
				...
				<div class="box-header">
					<h3 class="box-title">
					<label>
					<a class="btn-sm btn-primary" href="<?php echo base_url("superadmin/dosen_tambah");?>"><i class="fa fa-plus"></i> <span>Tambah Dosen</span></a>
					</label>
					</h3>
				</div>
				<div class="box-body">
...
var myTable =  $('#datatable').DataTable({
			...
			"info": true,
			'order': [[0, 'asc']],
			"ajax": "<?php echo base_url('superadmin/get_data_master_dosen/');?>" ,
			columnDefs: [{
				   targets: [7],
				   data: null,
