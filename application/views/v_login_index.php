...
<body class="hold-transition skin-red layout-top-nav" onload="tampilkanwaktu();setInterval('tampilkanwaktu()', 1000);">
<table width="100%" style="border-bottom:1px solid black;">
<tr>
	<td style="text-align:left;" class="example">
		<h4 style="text-align:center; font-size:1em"><b>Aplikasi Bank Soal <br>
    ...
    <section>
		<div class="register-box"> 
			<div class="account-wall">
			 ...
			 <h5 class="login-box-msg" style="color: red;"><?php echo $hasillogin;?></h5>
