		...
		<div class="col-xs-12">
			<div class="box">
				<div class="box-header">
					...
					?>
						<p style="color:green;"><i>Profile Prodi sukses diubah.</i></p>
					<?php 	
					}
					if($err==1){
				...
				<div class="box-body">
				  <div class="row">
				  <?php echo form_open_multipart("adminprodi/profile_aksi_ubah/$tbl_prodi->id_prodi"); ?>
					<div class="col-md-4">
					  ...
					  <div class="form-group">
						...
						<input type="hidden" name="id_user_admin_prodi" value="<?php echo $tbl_user2_by->id_user;?>" >
					  </div>
					  <div class="form-group">
