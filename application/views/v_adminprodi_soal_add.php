      ...
      <div class="row">
		<div class="col-xs-12">
			<div class="box">
				...
				<div class="box-body">
				  <div class="row">
				  <?php echo form_open_multipart("adminprodi/soal_aksi_tambah"); ?>
					<div class="col-md-3">
...
$(document).ready(function() {	
		...
		$.ajax({
			url: "<?php echo base_url('adminprodi/kelasmahasiswa_matakuliah');?>",
			type     : 'POST',
			dataType : 'html',
		...
		$.ajax({
			url: "<?php echo base_url('adminprodi/kelasmahasiswa_kelasmahasiswa');?>",
			type     : 'POST',
			dataType : 'html',
			data: 'id_prodi='+id_prodi,
			cache: false,
