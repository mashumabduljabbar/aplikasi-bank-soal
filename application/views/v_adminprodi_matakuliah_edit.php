      ...
      <div class="row">
		<div class="col-xs-12">
			<div class="box">
				...
				<div class="box-body">
				  <div class="row">
				  <?php echo form_open_multipart("adminprodi/matakuliah_aksi_ubah/$tbl_matakuliah->id_matakuliah"); ?>
					<div class="col-md-4">
					 ...
					 <input type="hidden" name="id_prodi" value="<?php echo $tbl_matakuliah->id_prodi;?>">
					  <div class="form-group">
